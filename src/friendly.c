...
void Step(int N, int M, T_FP * volumes, T_FP * pressures, T_FP * temperatures, T_FP * new_temperatures, T_INT * bounds){
...
int main(){
	...
	initialize_tracing();
	define_regions(1000,"Pressures_novec","Temperatures","Volumes","Delta","Pressures_vec");
	disable_tracing();
